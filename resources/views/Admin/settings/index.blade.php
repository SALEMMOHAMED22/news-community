            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text"  value="{{ $getSetting->instagram }}" name="instagram" placeholder="Enter insagram Link" class="form-control">
                        @error('insagram')
                        <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text"  value="{{ $getSetting->youtube }}" name="youtube" placeholder="Enter Youtupe Link "
                            class="form-control">
                    </div>
                </div>
            </div>
