                ...
                <div id="notify_push" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    @forelse (auth()->guard('admin')->user()->unreadNotifications as $notification)
                        <a class="dropdown-item d-flex align-items-center"
                            href="{{ $notification->data['link'] }}?notify_admin={{ $notification->id }}">
                            <div class="mr-3">
                            ...
                            <div>
                                ...
                                <span class="font-weight-bold">{{ $notification->data['contact_title'] }}</span>
                            </div>
                        </a>
                    @empty
                        <div class="dropdown-item text-center large text-black-500">
                            No notifications
                        </div>
                    @endforelse
